...
class ConstraintService:
    ...
    @staticmethod
    def add_constraints(endpoint_id, trace_id, trace, inputs, symbolic_context_loss, symbolic_precision_loss):
        """
        ...
        Database.instance().add_trace(endpoint_id, trace_id, trace, inputs, symbolic_context_loss, symbolic_precision_loss)
