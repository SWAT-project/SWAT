...
class Database:
    ...
    def __init__(self):
        ...
        self.violations = {}
        self.optimize_solutions = False  # Whether to use Z3 Optimize() to minimize values
        self.log_smt_formulas = False  # Whether to log SMT formulas and models to disk for debugging
