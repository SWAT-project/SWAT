...
java \
-Xmx16g \
-Dconfig.path=../targets/applications/oss-fuzz/java-diff-utils/swat.cfg \
...
-jar ../targets/applications/oss-fuzz/java-diff-utils/build/libs/java-diff-utils-0.0.1-SNAPSHOT.jar
