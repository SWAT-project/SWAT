...
public class FacilityLocationDemoDataBuilder {
    ...
    private FacilityLocationDemoDataBuilder() {
    }

    public static FacilityLocationDemoDataBuilder builder() {
        return new FacilityLocationDemoDataBuilder();
    }

    public FacilityLocationDemoDataBuilder setCapacity(long capacity) {
        this.capacity = capacity;
        return this;
    }

    public FacilityLocationDemoDataBuilder setDemand(long demand) {
        this.demand = demand;
        return this;
    }

    public FacilityLocationDemoDataBuilder setFacilityCount(int facilityCount) {
        this.facilityCount = facilityCount;
        return this;
    }

    public FacilityLocationDemoDataBuilder setConsumerCount(int consumerCount) {
        this.consumerCount = consumerCount;
        return this;
    }

    public FacilityLocationDemoDataBuilder setAverageSetupCost(long averageSetupCost) {
        this.averageSetupCost = averageSetupCost;
        return this;
    }

    public FacilityLocationDemoDataBuilder setSetupCostStandardDeviation(long setupCostStandardDeviation) {
        this.setupCostStandardDeviation = setupCostStandardDeviation;
        return this;
    }

    public FacilityLocationDemoDataBuilder setSouthWestCorner(Location southWestCorner) {
        this.southWestCorner = southWestCorner;
        return this;
    }

    public FacilityLocationDemoDataBuilder setNorthEastCorner(Location northEastCorner) {
