...
java \
-Xmx16g \
-Dconfig.path=../targets/applications/emb-artificial/ncs-target/swat.cfg \
-Djava.library.path=$(pwd)/../libs/java-library-path \
"-javaagent:../libs/jacoco/jacocoagent.jar=destfile=$JACOCO_EXEC_FILE,output=file,sessionid=$JACOCO_SESSION,includes=org.restncs.*,dumponexit=true" \
