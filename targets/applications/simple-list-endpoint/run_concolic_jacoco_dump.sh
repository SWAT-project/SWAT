...
java \
-Xmx16g \
-Dconfig.path=../targets/applications/simple-list-endpoint/swat-evomaster.cfg \
...
-jar ../targets/applications/simple-list-endpoint/build/libs/simple-list-endpoint-0.0.1-SNAPSHOT.jar
