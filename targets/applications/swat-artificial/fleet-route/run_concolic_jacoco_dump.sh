...
java \
-Xmx16g \
-Dconfig.path=../targets/applications/swat-artificial/fleet-route/swat.cfg \
...
-jar ../targets/applications/swat-artificial/fleet-route/build/libs/fleet-route-0.0.1-SNAPSHOT.jar
