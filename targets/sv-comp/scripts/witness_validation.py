...
def generate_and_validate_witness(ver_task: VerificationTask, output: List[str]) -> Optional[bool]:
    """Extract witnesses from `output`, create witness files and validate them.

    Returns True/False on validation result or None if no witness was found.
    """
