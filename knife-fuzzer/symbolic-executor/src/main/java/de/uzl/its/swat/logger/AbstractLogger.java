...
public abstract class AbstractLogger implements Logger {
    ...
    public void TABLESWITCH(
        ...
        log(new TABLESWITCH(iid, mid, min, max, dflt, labels, values));
    }
    ...
    public void INVOKEDYNAMIC(
        ...
        log(new INVOKEDYNAMIC(iid, mid, owner, name, desc, lambda));
    }
    ...
    public void NEWARRAY(int iid, int mid, int atype) {
        log(new NEWARRAY(iid, mid, atype));
    }
    ...
    public void LOOP_BEGIN(int iid) {
        log(new LOOP_BEGIN(iid));
    }

    public void LOOP_END(int iid) {
        log(new LOOP_END(iid));
    }
