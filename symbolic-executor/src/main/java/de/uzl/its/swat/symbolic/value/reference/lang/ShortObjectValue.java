...
public final class ShortObjectValue extends BoxedValue<ShortValue> {

    private final IntegerFormulaManager ifm;
    private final StringFormulaManager sfm;

    public ShortObjectValue(SolverContext ctx, ShortValue val, int address) {
        super(ctx, address);
        SWATAssert.enforce(val != null, "Short has to be instantiated with default value!");
        this.val = val;
     ...
     */
    @Override
    public BooleanFormula getBounds(boolean upper) throws NullPointerException {
    ...
    private Value<?, ?> invokeInit(Value<?, ?>[] args, Type[] desc) {
        if (args[0] instanceof ShortValue sv) {
            this.val = new ShortValue(context, sv.concrete, sv.formula);
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#shortValue()">shortValue</a>().
     * Returns the primitive short value of this Short object.
     *
     ...
     * @return The primitive ShortValue
     */
    private Value<?, ?> invokeShortValue(Value<?, ?>[] args, Type[] desc) {
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#byteValue()">byteValue</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#doubleValue()">doubleValue</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#floatValue()">floatValue</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#intValue()">intValue</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#longValue()">longValue</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#toString()">toString</a>().
    ...
    private Value<?, ?> invokeToString(Value<?, ?>[] args, Type[] desc) {
        ...
        return new StringValue(
                context,
                val.concrete.toString(),
                integralToStringFormula(val.asIntegerFormula()),
                -1);
    }

    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#hashCode()">hashCode</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#equals(java.lang.Object)">equals</a>().
     * Compares this Short object with another object for equality.
     *
    ...
    private Value<?, ?> invokeEquals(Value<?, ?>[] args, Type[] desc) {
        ...
        Value<?, ?> other = args[0];
        try {
            ShortValue otherShort = other.asShortValue();
            boolean result = val.concrete.equals(otherShort.concrete);
            BitvectorFormulaManager bvmgr = context.getFormulaManager().getBitvectorFormulaManager();
            return new BooleanValue(context, result, bvmgr.equal(val.formula, otherShort.formula));
        } catch (Exception ignored) {
            return PlaceHolder.instance; // If the other value is not a ShortValue, return PlaceHolder
        }
    }

    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#compareTo(java.lang.Short)">compareTo</a>().
     * Compares this Short instance with another Short instance.
     *
     * @param args List of Values that correspond to the method arguments
     * @param desc Array of Type descriptions of the methods' signature
    ...
    private Value<?, ?> invokeCompareTo(Value<?, ?>[] args, Type[] desc) throws NotImplementedException {
        if (args.length == 1) {
            ShortObjectValue other = args[0].asShortObjectValue();
            int result = val.concrete.compareTo(other.val.concrete);

            // compareTo returns the actual difference: this - other
            // Sign-extend both to 32-bit and subtract
            BitvectorFormulaManager bvmgr = context.getFormulaManager().getBitvectorFormulaManager();
            BitvectorFormula thisExt = bvmgr.extend(val.formula, 16, true);  // sign extend
            BitvectorFormula otherExt = bvmgr.extend(other.val.formula, 16, true);
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#describeConstable()">describeConstable</a>().
    ...
    /**
     * Invocation handling for the Short instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Short.html#resolveConstantDesc(java.lang.invoke.MethodHandles.Lookup)">resolveConstantDesc</a>().
     * Returns PlaceHolder since requires complex reflection-based functionality.
     *
     * @param args List of Values that correspond to the method arguments
     * @param desc Array of Type descriptions of the methods' signature
    ...
    /**
     * Custom equals method for ShortObjectValue. Proper handling for boxing is still needed, see
     * Issue #42. Checks if either the two ShortObjectValues are equal or the primitive ShortValues
     * are equal.
     *
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof ShortObjectValue other) {
            return (val.equals(other.val));
        } else if (o instanceof ShortValue other) {
    ...
    @Override
    public ShortObjectValue asShortObjectValue() {
        return this;
    }
    ...
    public String toString() {
        return "Ljava/lang/Short; @" + Integer.toHexString(address) + " -> " + val;
    }
}
