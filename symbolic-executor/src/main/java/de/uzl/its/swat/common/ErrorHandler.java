 ...
 * It decides whether to log the error or terminate the execution based on the application configuration.
 */
public class ErrorHandler {
    ...
    /**
     * Handles an exception with a custom message. Depending on the application configuration,
     * it either logs the error or terminates the execution by throwing a RuntimeException.
     *
