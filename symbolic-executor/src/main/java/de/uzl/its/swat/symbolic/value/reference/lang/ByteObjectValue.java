...
public class ByteObjectValue extends BoxedValue<ByteValue> {

    private final IntegerFormulaManager ifm;
    private final StringFormulaManager sfm;

    public ByteObjectValue(SolverContext ctx, ByteValue val, int address) {
        super(ctx, address);
        SWATAssert.enforce(val != null, "Byte has to be instantiated with default value!");
        this.val = val;
     ...
     * @return The ByteFormula that represents the bounds check
     */
    @Override
    ...
    private Value<?, ?> invokeInit(Value<?, ?>[] args, Type[] desc) {
        if (args[0] instanceof ByteValue bv) {
            this.val = new ByteValue(context, bv.concrete, bv.formula);
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#byteValue()">byteValue</a>().
     * Returns the primitive byte value of this Byte object.
     *
     ...
     * @return The primitive ByteValue
     */
    private Value<?, ?> invokeByteValue(Value<?, ?>[] args, Type[] desc) {
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#shortValue()">shortValue</a>().
     * Returns the value as a short after widening primitive conversion.
     *
     * @param args List of Values that correspond to the method arguments (should be empty)
     * @param desc Array of Type descriptions of the methods' signature
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#intValue()">intValue</a>().
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#longValue()">longValue</a>().
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#floatValue()">floatValue</a>().
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#doubleValue()">doubleValue</a>().
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#toString()">toString</a>().
   ...
   private Value<?, ?> invokeToString(Value<?, ?>[] args, Type[] desc) {
    ...
    return new StringValue(
            ...
            integralToStringFormula(this.val.asIntegerFormula()),
            -1);
}

    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#hashCode()">hashCode</a>().
     * Returns a hash code for this Byte object.
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#equals(java.lang.Object)">equals</a>().
     * Compares this Byte object with another object for equality.
     *
    ...
    private Value<?, ?> invokeEquals(Value<?, ?>[] args, Type[] desc) {
        ...
        Value<?, ?> other = args[0];
        try {
            ByteValue otherByte = other.asByteValue();
            boolean result = val.concrete.equals(otherByte.concrete);
            BitvectorFormulaManager bvmgr = context.getFormulaManager().getBitvectorFormulaManager();
            return new BooleanValue(context, result, bvmgr.equal(val.formula, otherByte.formula));
        } catch (Exception ignored) {
            return PlaceHolder.instance; // If the other value is not a ByteValue, return PlaceHolder
        }
    }

    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#compareTo(java.lang.Byte)">compareTo</a>().
     * Compares this Byte instance with another Byte instance.
     *
     * @param args List of Values that correspond to the method arguments
     * @param desc Array of Type descriptions of the methods' signature
    ...
    private Value<?, ?> invokeCompareTo(Value<?, ?>[] args, Type[] desc) throws NotImplementedException {
        if (args.length == 1) {
            ByteObjectValue other = args[0].asByteObjectValue();
            ...
            BitvectorFormulaManager bvmgr = context.getFormulaManager().getBitvectorFormulaManager();
            BitvectorFormula thisExt = bvmgr.extend(val.formula, 24, true);
            BitvectorFormula otherExt = bvmgr.extend(other.val.formula, 24, true);
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#describeConstable()">describeConstable</a>().
    ...
    /**
     * Invocation handling for the Byte instance method <a
     * href="https://docs.oracle.com/en/java/javase/17/docs/api/java.base/java/lang/Byte.html#resolveConstantDesc(java.lang.invoke.MethodHandles.Lookup)">resolveConstantDesc</a>().
     * Returns PlaceHolder since requires complex reflection-based functionality.
     *
     * @param args List of Values that correspond to the method arguments
     * @param desc Array of Type descriptions of the methods' signature
    ...
    public boolean equals(Object o) {
        ...
        if (o instanceof ByteObjectValue other) {
            return (val.equals(other.val));
        } else if (o instanceof ByteValue other) {
    ...
    @Override
    public ByteObjectValue asByteObjectValue() {
        return this;
    }
    ...
    public String toString() {
        return "Ljava/lang/Byte; @" + Integer.toHexString(address) + " -> " + val;
    }
}
