...
/**
 * Represents a special element in the symbolic trace. Special elements are used in places where
 * branching might happen that is not currently supported. This includes future features such as
 * exception handling, but also behaviour such as static initializers.
 */
@Getter
