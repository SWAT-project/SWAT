...
public class Intrinsics {
    ...
    // Array injection methods
    public static int[] injectAssignment(int[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[I",
                Intrinsics::parseIntArray, Type.getType(int[].class));
    }

    public static long[] injectAssignment(long[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[J",
                Intrinsics::parseLongArray, Type.getType(long[].class));
    }

    public static boolean[] injectAssignment(boolean[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[Z",
                Intrinsics::parseBooleanArray, Type.getType(boolean[].class));
    }

    public static byte[] injectAssignment(byte[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[B",
                Intrinsics::parseByteArray, Type.getType(byte[].class));
    }

    public static char[] injectAssignment(char[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[C",
                Intrinsics::parseCharArray, Type.getType(char[].class));
    }

    public static short[] injectAssignment(short[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[S",
                Intrinsics::parseShortArray, Type.getType(short[].class));
    }

    public static float[] injectAssignment(float[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[F",
                Intrinsics::parseFloatArray, Type.getType(float[].class));
    }

    public static double[] injectAssignment(double[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[D",
                Intrinsics::parseDoubleArray, Type.getType(double[].class));
    }

    public static String[] injectAssignment(String[] value, long uid) {
        return injectAssignmentGeneric(uid, value, "[Ljava/lang/String;",
                Intrinsics::parseStringArray, Type.getType(String[].class));
    }

    // Shared ObjectMapper instance for JSON parsing (thread-safe)
    private static final ObjectMapper JSON_MAPPER = new ObjectMapper();

    // Array parsing helper methods using Jackson for proper JSON parsing
    private static int[] parseIntArray(String json) {
        try {
            // Use Jackson to parse JSON array into String array
            String[] parts = JSON_MAPPER.readValue(json, String[].class);
            int[] result = new int[parts.length];
            // Use existing proven parsing logic for each string element
            for (int i = 0; i < parts.length; i++) {
                result[i] = Integer.parseInt(parts[i].trim());
            }
            return result;
        } catch (Exception e) {
            throw new RuntimeException("Failed to parse int array from JSON: " + json, e);
        }
    }
    ...
    private static long[] parseLongArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse long array from JSON: " + json, e);
        }
    }
    ...
    private static boolean[] parseBooleanArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse boolean array from JSON: " + json, e);
        }
    }
    ...
    private static byte[] parseByteArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse byte array from JSON: " + json, e);
        }
    }

    private static char[] parseCharArray(String json) {
        try {
            String[] parts = JSON_MAPPER.readValue(json, String[].class);
            ...
            for (int i = 0; i < parts.length; i++) {
                ...
                if (part.length() == 1) {
                    ...
                    result[i] = (char) Integer.parseInt(part);
                }
            }
            return result;
        } catch (Exception e) {
            throw new RuntimeException("Failed to parse char array from JSON: " + json, e);
        }
    }
    ...
    private static short[] parseShortArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse short array from JSON: " + json, e);
        }
    }
    ...
    private static float[] parseFloatArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse float array from JSON: " + json, e);
        }
    }
    ...
    private static double[] parseDoubleArray(String json) {
        try {
            ...
            throw new RuntimeException("Failed to parse double array from JSON: " + json, e);
        }
    }

    private static String[] parseStringArray(String json) {
        try {
            // Parse JSON array directly into String array
            // Jackson handles proper JSON string escaping (quotes, commas, etc.)
            return JSON_MAPPER.readValue(json, String[].class);
        } catch (Exception e) {
            throw new RuntimeException("Failed to parse String array from JSON: " + json, e);
        }
    }
    ...
    public static String[] liftValue(String[] value, long uid) {
        logger.info("[DSE] Initializing symbolic tracking for String[] with length: {}", value != null ? value.length : 0);
        return value;
    }
    ...
    public static String[] liftValue(String[] value, String prefix, long uid) {
        logger.info("[DSE] Initializing symbolic tracking for String[] with prefix '{}' and length: {}", prefix, value != null ? value.length : 0);
        return value;
    }
