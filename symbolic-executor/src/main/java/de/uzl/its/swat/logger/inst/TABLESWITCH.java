 ...
 * For more information see the  <a href="https://docs.oracle.com/javase/specs/jvms/se21/html/jvms-6.html#jvms-6.5.tableswitch">Java VM specification</a>.
 */
public class TABLESWITCH extends Instruction {
    ...
    public String toString() {
        return genericToString("TABLESWITCH [" + min + "-" + max +"] labels: " + labels + " values: " + values + " dflt: " + dflt);
    }
}